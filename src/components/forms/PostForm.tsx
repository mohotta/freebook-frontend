...
import { CreatePostValidationScheme } from '@/lib/validation'
...
const PostForm = ( {post, action}: PostFormProps ) => {
    ...
    const form = useForm<z.infer<typeof CreatePostValidationScheme>>({
        resolver: zodResolver(CreatePostValidationScheme),
        defaultValues: {
    ...
    async function onSubmit(values: z.infer<typeof CreatePostValidationScheme>) {
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-9 w-full max-w-5xl">
                ...
                render={({ field }) => (
                    <FormItem>
                        ...
                        <FormControl>
                        <Input {...field} type='text' className='shad-input' placeholder='Art, Expression, Cinema'/>
                        </FormControl>
                        <FormMessage className='shad-form_message'/>
                    </FormItem>
                )}
